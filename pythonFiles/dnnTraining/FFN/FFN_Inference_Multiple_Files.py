...
for root, dirs, files in os.walk('./predictionFiles/', topdown=False):
    for name in files:
...
with tf.Session(graph=graph) as sess:
    ...
    for file in allFilesTest:
        ...
        wavfile.write('C:/Users/mhp/Documents/GitHub/dnn-SpeechEnhancement/pythonFiles/dnnTraining/FFN/predictionFiles/' + newWavName,12000,y)
