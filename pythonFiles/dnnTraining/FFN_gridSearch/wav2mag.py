...
filePath = "C:/Users/s123028/dataset8_MulitTfNoise/TIMIT_val_feat/331_val_feat.wav"
filePath2 = "C:/Users/s123028/dataset8_MulitTfNoise/TIMIT_val_ref/331_val_ref.wav"
...
NUM_CLASSES = int(np.size(next_feat_pl,axis=1))
print(NUM_CLASSES)
...
with tf.Session() as sess:
    preds = FFNModel.defineFFN(next_feat_pl,NUM_CLASSES,phase=False)
...
features1 = np.transpose(features) * featStd
