...
for rate in learningRates:
	for layers in nLayers:
		...
		preds = FFN_Model_gridSearch.defineFFN(next_feat_pl,NUM_CLASSES,layers,keepProb,conigN)
		conigN += 1
			...
			for epoch in range(0,epoch_num):
				...
				while trainingBool:
					try:
						...
						# Early stopping #
						print(val_loss_best)
						if val_loss <= (val_loss_best * 0.99):
							trainingBool = True
							...
							saveStr = './savedModels/my_test_model_e' + str(epoch) + 'R' + str(rate)+ 'L' + str(layers) + '.ckpt'
